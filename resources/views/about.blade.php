...
<body class="page-about">
    ...
    <section id="about" class="about" >
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4" data-aos="fade-up">
          <div class="col-lg-4">
          <p>este sera donde nacio al aempresa</p>
    ...
    <section id="team" class="team" >
      <div class="container" data-aos="fade-up" >
        <div class="section-header" style="background-color: #2c9090; color: white: border-radius: 8px;">
          ...
          <div class="col-lg-3 col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              ...
              <div class="member-info">
                <h4>ING: Geovanni Pérez Polo</h4>
                <br><h4>Perfil</h4>

                @if (isset($archivo) && !empty($archivo))
                <a href="{{ Storage::url($archivo->ruta) }}" target="_blank">Hoja de vida</a>
                      @else
